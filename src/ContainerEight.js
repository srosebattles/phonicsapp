...
export default class ContainerEight extends Component {
  constructor(props) {
    super(props);
    this.state = {
      targetbins: [
      ...
      boxes: [
        { name: 'sh', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/soundSH.mp3' },
        { name: 'ch', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/soundCH.mp3' },
        { name: 'th', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/hardTH.mp3'},
