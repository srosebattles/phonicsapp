...
export default class ContainerFour extends Component {
  constructor(props) {
    super(props);
    this.state = {
      targetbins: [
      ...
      boxes: [
        { name: 'l', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/soundL.mp3' },
        { name: 'f', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/soundF.mp3' },
        { name: 'b', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/soundB2.mp3'},
        { name: 'j', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/soundJ.mp3'},
        { name: 'z', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/soundZ.mp3'},
      ],
      droppedBoxNames: [],
