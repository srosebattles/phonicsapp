...
export default class ContainerThree extends Component {
  constructor(props) {
    super(props);
    this.state = {
      targetbins: [
      ...
      boxes: [
        ...
        { name: 'd', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/soundD2.mp3' },
        { name: 'g', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/hardG.mp3'},
        { name: 'o', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/shortO.mp3'},
        { name: 'u', type: ItemTypes.BOX, origin: 'http://phonicsaudiofiles.s3.amazonaws.com/shortU.mp3'},
      ],
      droppedBoxNames: [],
